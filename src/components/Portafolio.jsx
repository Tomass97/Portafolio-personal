        ...
        {proyectos.map((proyecto, index) => {
          ...
          return (
            <motion.div
              ...
              key={index} 
              className={`bg-transparent max-w-screen-2xl mx-auto flex md:flex-row justify-center items-center gap-4 m-4 p-4 md:p-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} degradado bg-opacity-60 rounded-lg`}>
